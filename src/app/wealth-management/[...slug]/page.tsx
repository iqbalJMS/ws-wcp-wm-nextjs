...
import { ACT_GetSinglePage } from '@/app/wealth-management/$action/action.get.single-page';
...
import { T_Widget } from '@/app/wealth-management/$constant/types';
import { COMPONENT_MAP_WIDGET } from '@/app/wealth-management/$constant';
