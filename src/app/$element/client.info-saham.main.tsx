        ...
        <div className="p-10 rounded-md shadow-md space-y-8">
          <div className="flex md:flex-row flex-col justify-between items-center gap-4">
            <div>
              ...
              <h2>{`Pembaharuan terakhir ${lastUpdate.substring(0, 4)}/${lastUpdate.substring(4, 6)}/${lastUpdate.substring(6, 8)} ${lastUpdate.substring(9)} WIB Untuk transaksi kurang dari eq. USD 2.500`}</h2>
            </div>
            <Link
