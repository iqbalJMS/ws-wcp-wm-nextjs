      ...
      <div className="h-[30rem] relative">
        ...
        <div className='z-20 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mdmax:w-full'>
          <div className='text-center mb-10'>
            <div className='text-white text-3xl mb-5 font-semibold'>{title}</div>
            <div className='text-white text-2xl mdmax:text-lg w-[80%] inline-block'>{parseHTMLToReact(description)}</div>
          </div>
          <div className='text-center'>
            <Link href={button.link} extern={button.external}>
