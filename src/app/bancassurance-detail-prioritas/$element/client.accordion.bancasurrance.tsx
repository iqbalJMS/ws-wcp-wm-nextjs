...
export default function CE_AccordionBancarsurance({
  renderContent,
  isOpen,
  renderTitle,
}: T_AccordionProps) {
  ...
  return (
    <section className="flex flex-col mb-4">
      <div
        ...
        className={`shadow-lg rounded-[40px] px-6 py-4 cursor-pointer bg-prioritycolor relative z-10`}
      >
        <div>
          <div>
      ...
      <div
        className={`${styles.renderContent} ${accordionOpen ? 'grid-rows-[1fr] opacity-100 pt-16 px-16 pb-6 w-full' : 'grid-rows-[0fr] opacity-0'}`}
      >
        {parseHTMLToReact(
          renderContent,
