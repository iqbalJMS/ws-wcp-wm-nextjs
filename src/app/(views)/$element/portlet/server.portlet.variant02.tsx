    ...
    <>
      <div>
        <div className="relative bg-transparent lg:min-h-[25.75rem] mx-auto w-full ">
          <div
            className="relative h-[80vh] lg:mb-[3.125rem] w-full overflow-hidden bg-cover before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-gradient-to-b before:from-black before:to-black before:opacity-40"
            style={{
              backgroundImage: `url(${background ?? '/images/no-image.png'})`,
              backgroundSize: 'cover',
            }}
          >
            <div className="absolute w-full h-full flex flex-col pl-12 justify-center items-center border-b-[15px] border-[#D2D2D2]">
              <div className="mb-3 max-w-[60.125rem]">
                {title && (
                  <div className="text-white text-[43px] font-bold mb-3 uppercase text-center">
                    {parseHTMLToReact(title)}
                  </div>
                )}
                {subtitle && (
                  <div className="text-white font-normal text-sm text-center">
