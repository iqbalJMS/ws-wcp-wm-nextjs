...
export default function CE_CarouselVariant3({
  ...
  return (
    <>
      <div className="hidden w-full h-[80vh] xl:flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <motion.div
          // animate={{ y: -100 }}
          // transition={{ duration: 1, ease: 'anticipate' }}
          className="relative flex justify-center w-10/12 lg:w-11/12 xl:w-10/12 overflow-hidden"
        >
          <div
            ...
            ref={sliderRef}
            className="flex justify-start items-center transition-transform duration-700 ease-in-out transform-gpu w-full drop-shadow-2xl -space-x-20"
          >
      ...
      <div className="w-full h-[80vh] flex flex-col xl:hidden items-center justify-center relative overflow-hidden">
        <section className="flex justify-between w-11/12 xl:w-8/12  pb-5 md:pb-0">
        ...
        <motion.div className="relative w-10/12 lg:w-11/12 xl:w-9/12 overflow-hidden">
          <div
            onMouseDown={handleMouseDown}
            onMouseMove={handleMouseMove}
            onMouseUp={handleMouseUp}
