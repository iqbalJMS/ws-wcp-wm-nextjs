...
export function TabsOutlet({
  ...
  return (
    <>
      <div className="w-full flex justify-center py-10 border-y-2">
        <div className="w-96 flex justify-center space-x-2">
          {list.map((item, index) => {
            return (
              <div
                key={index}
                ...
                className={[
                  `flex justify-center items-start p-2 border-b cursor-pointer relative group/tab text-center`,
