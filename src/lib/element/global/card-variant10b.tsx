              ...
              <div className="text-[#1738C1] text-sm tracking-wide leading-relaxed">
                  ...
                  <table className="w-full md:w-9/12 lg:w-8/12 table-auto">
                    ...
                    <tbody>
                      {LIST_TABEL_CONTENT.map((item, index) => (
                        <tr
                          key={index}
                          className="space-y-2 font-light text-sm "
                        >
                ...
                <ul className="list-decimal pl-5 space-y-1">
                  <li>
                    ...
                    berdasarkan premi tahunan untuk pembayaran 5 (lima) tahun
                    dan 10 (sepuluh) tahun. Sedangkan untuk premi tunggal
                    perhitungan cashback berdasarkan premi sekaligus.
                  </li>
                  ...
                  <li>
                    ...
                    otomatis mendapatkan cashback tanpa perlu melakukan
                    pengajuan program.
                  </li>
                  <li>
