            ...
            <div className="sm:basis-4/5">
              <div className="text-[#1738C1] space-y-3 text-sm tracking-wide leading-relaxed">
                ...
                <h2 className="">
                  ...
                  jaminan atas kerusakan pada harta benda dan tempat tinggal
                  yang secara langsung disebabkan oleh Kerusakan atau Kerugian
                  Material (Kebakaran, Petir, Ledakan Asap, beserta
                  Perluasannya), serta memberikan santunan Kecelakaan Diri dan
                  Kesehatan, Bantuan Sewa, serta perlindungan Tanggung Jawab
                  Pihak Ketiga.
                </h2>
                <h2>
                ...
                <h2 className="py-2">a. Kerusakan</h2>
                Kerugian Material Produk ini menjamin kerugian atau kerusakan
                ...
                <h2>b. Kecelakaan Diri Dan Kesehatan</h2>
                <ul className="list-disc pl-14">
                  <li>Meninggal dunia atau cacat tetap.</li>
                  <li>Santunan Biaya Pengobatan atau Perawatan Medis.</li>
                </ul>
                <h2>c. Bantuan Sewa</h2>
                <h2>
                  Bila objek Pertanggungan mengalami kerugian yang dijamin dalam
                  polis dan sudah tidak layak dihuni maka Bantuan Sewa akan
                  diberikan.
                </h2>
                <h2>d. Tanggung Jawab Hukum Kepada Pihak Ketiga</h2>
                <h2>
                  Produk ini menjamin kerugian kepada Pihak Ketiga atas
                  kerusakan fisik/ materi milik Plhak Ketiga akibat dari
                  kerugian yang dijamin dalam polis, yang dibayarkan kepada
                  Tertanggung setinggi - tingginya sebesar Santunan yang
                  tercantum dalam polls. Pembayaran santunan diberikan atas
                  dasar Surat Tuntutan dari Pihak Ketiga.Rate
                </h2>
                <h2>Premi</h2>
                ...
                <h2 className="pb-2">
                  Nikmati privilege penyewaan Safe Deposit Box khusus bagi
                  nasabah BRI Private dan BRI Prioritas di Sentra Layanan
                  Prioritas dan Private
                </h2>
                <h2>Berikut Jenis dari Safe Deposit Box:</h2>
                <Image
