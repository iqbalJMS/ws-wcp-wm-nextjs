  ...
  return (
    <div ref={refElement} className="relative">
      <button
        ...
        className={[
          `${isScrolling ? 'hover:border-blue-800 border-2 border-white' : 'hover:bg-privatecolor focus:bg-privatecolor focus:border-white focus:border-4 focus:text-white'}`,
